...
// 房间号
const roomNum = ref<string | null | number>(838505786320)

const relayWs = ref<string>("ws://localhost:8080")
// 弹幕列表
...
function mockMess(giftname: string) {
  const mockData = {
    id: 7335727571088250000,
    type: "gift",
    nickname: "派西维尔",
    content: giftname,
    memberCount: 0,
    ...
    totalUserCount: 0,
    rank: [],
    gift: { name: giftname, count: 0, url: "", desc: "" },
  }
